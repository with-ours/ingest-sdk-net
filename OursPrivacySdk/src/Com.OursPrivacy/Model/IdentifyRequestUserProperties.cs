...
namespace Com.OursPrivacy.Model
{
    ...
    /// </summary>
    public partial class IdentifyRequestUserProperties : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IdentifyRequestUserProperties" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IdentifyRequestUserProperties {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="IdentifyRequestUserProperties" />
    /// </summary>
    public class IdentifyRequestUserPropertiesJsonConverter : JsonConverter<IdentifyRequestUserProperties>
    {
        /// <summary>
        /// Deserializes json to <see cref="IdentifyRequestUserProperties" />
        /// </summary>
        ...
        public override IdentifyRequestUserProperties Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new IdentifyRequestUserProperties(email, firstName, lastName, gender, dateOfBirth, phoneNumber, city, state, zip, country, externalId, companyName, jobTitle, ip, customProperties);
        }

        /// <summary>
        /// Serializes a <see cref="IdentifyRequestUserProperties" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="identifyRequestUserProperties"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, IdentifyRequestUserProperties identifyRequestUserProperties, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, identifyRequestUserProperties, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="IdentifyRequestUserProperties" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="identifyRequestUserProperties"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, IdentifyRequestUserProperties identifyRequestUserProperties, JsonSerializerOptions jsonSerializerOptions)
        {
            if (identifyRequestUserProperties.EmailOption.IsSet)
                if (identifyRequestUserProperties.EmailOption.Value != null)
                    writer.WriteString("email", identifyRequestUserProperties.Email);
                else
                    writer.WriteNull("email");

            if (identifyRequestUserProperties.FirstNameOption.IsSet)
                if (identifyRequestUserProperties.FirstNameOption.Value != null)
                    writer.WriteString("first_name", identifyRequestUserProperties.FirstName);
                else
                    writer.WriteNull("first_name");

            if (identifyRequestUserProperties.LastNameOption.IsSet)
                if (identifyRequestUserProperties.LastNameOption.Value != null)
                    writer.WriteString("last_name", identifyRequestUserProperties.LastName);
                else
                    writer.WriteNull("last_name");

            if (identifyRequestUserProperties.GenderOption.IsSet)
                if (identifyRequestUserProperties.GenderOption.Value != null)
                    writer.WriteString("gender", identifyRequestUserProperties.Gender);
                else
                    writer.WriteNull("gender");

            if (identifyRequestUserProperties.DateOfBirthOption.IsSet)
                if (identifyRequestUserProperties.DateOfBirthOption.Value != null)
                    writer.WriteString("date_of_birth", identifyRequestUserProperties.DateOfBirth);
                else
                    writer.WriteNull("date_of_birth");

            if (identifyRequestUserProperties.PhoneNumberOption.IsSet)
                if (identifyRequestUserProperties.PhoneNumberOption.Value != null)
                {
                    writer.WritePropertyName("phone_number");
                    JsonSerializer.Serialize(writer, identifyRequestUserProperties.PhoneNumber, jsonSerializerOptions);
                }
                else
                    writer.WriteNull("phone_number");
            if (identifyRequestUserProperties.CityOption.IsSet)
                if (identifyRequestUserProperties.CityOption.Value != null)
                    writer.WriteString("city", identifyRequestUserProperties.City);
                else
                    writer.WriteNull("city");

            if (identifyRequestUserProperties.StateOption.IsSet)
                if (identifyRequestUserProperties.StateOption.Value != null)
                    writer.WriteString("state", identifyRequestUserProperties.State);
                else
                    writer.WriteNull("state");

            if (identifyRequestUserProperties.ZipOption.IsSet)
                if (identifyRequestUserProperties.ZipOption.Value != null)
                {
                    writer.WritePropertyName("zip");
                    JsonSerializer.Serialize(writer, identifyRequestUserProperties.Zip, jsonSerializerOptions);
                }
                else
                    writer.WriteNull("zip");
            if (identifyRequestUserProperties.CountryOption.IsSet)
                if (identifyRequestUserProperties.CountryOption.Value != null)
                    writer.WriteString("country", identifyRequestUserProperties.Country);
                else
                    writer.WriteNull("country");

            if (identifyRequestUserProperties.ExternalIdOption.IsSet)
                if (identifyRequestUserProperties.ExternalIdOption.Value != null)
                    writer.WriteString("external_id", identifyRequestUserProperties.ExternalId);
                else
                    writer.WriteNull("external_id");

            if (identifyRequestUserProperties.CompanyNameOption.IsSet)
                if (identifyRequestUserProperties.CompanyNameOption.Value != null)
                    writer.WriteString("company_name", identifyRequestUserProperties.CompanyName);
                else
                    writer.WriteNull("company_name");

            if (identifyRequestUserProperties.JobTitleOption.IsSet)
                if (identifyRequestUserProperties.JobTitleOption.Value != null)
                    writer.WriteString("job_title", identifyRequestUserProperties.JobTitle);
                else
                    writer.WriteNull("job_title");

            if (identifyRequestUserProperties.IpOption.IsSet)
                if (identifyRequestUserProperties.IpOption.Value != null)
                    writer.WriteString("ip", identifyRequestUserProperties.Ip);
                else
                    writer.WriteNull("ip");

            if (identifyRequestUserProperties.CustomPropertiesOption.IsSet)
                if (identifyRequestUserProperties.CustomPropertiesOption.Value != null)
                {
                    writer.WritePropertyName("custom_properties");
                    JsonSerializer.Serialize(writer, identifyRequestUserProperties.CustomProperties, jsonSerializerOptions);
                }
                else
